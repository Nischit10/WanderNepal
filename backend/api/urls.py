...
from .views import (
    SignupView, SigninView, DestinationListView, DestinationDetailView, 
    BookingCreateView, UserBookingListView, BookingDetailView, BookingCancelView,
    NavigationView
)
...
urlpatterns = [
    ...
    path('navigation/<int:destination_id>/', NavigationView.as_view(), name='navigation'),
]
