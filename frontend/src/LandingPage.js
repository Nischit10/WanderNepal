...
export default function LandingPage() {
  ...
  const goExperience = (key) => {
    const found = allDests.find(d => 
      d.category.toLowerCase() === key.toLowerCase() || 
      d.name.toLowerCase().includes(key.toLowerCase())
    );
    if (found) navigate(`/destinations/${found.id}`);
  ...
  return (
    <>
      ...
      <div style={{ background: "#fafafa" }} id="destinations">
        <div className="section">
          <div className="section-header">
            ...
            <p className="section-desc">Hand-picked treks and tours curated by local Himalayan experts.</p>
          </div>

          {featuredLoading && (
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "60px 0", gap: 14 }}>
              <div style={{ width: 36, height: 36, border: "3px solid #f0f0f0", borderTopColor: "#1a6bff", borderRadius: "50%", animation: "fspin 0.8s linear infinite" }} />
              <p style={{ fontSize: 14, color: "#888" }}>Loading destinations...</p>
            </div>
          )}
          ...
          {featuredError && !featuredLoading && (
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "60px 0", gap: 12, textAlign: "center" }}>
              ...
              <p style={{ fontSize: 16, fontWeight: 700 }}>Couldn't load destinations</p>
              <p style={{ fontSize: 14, color: "#888" }}>{featuredError}</p>
              <button onClick={loadFeatured} style={{ background: "#1a6bff", color: "white", border: "none", padding: "10px 24px", borderRadius: 20, fontSize: 13, fontWeight: 600, cursor: "pointer" }}>Try again</button>
            </div>
          )}
          ...
          {!featuredLoading && !featuredError && (
            <>
              ...
              <div style={{ display: "flex", justifyContent: "center", marginTop: 36 }}>
                <button onClick={() => navigate("/destinations")} style={{ background: "#1a6bff", color: "white", border: "none", padding: "13px 36px", borderRadius: 28, fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "'Inter', sans-serif" }}>
        ...
        <div className="cta-banner">
          ...
          <div className="cta-content">
            ...
            <div className="cta-btns">
              ...
              <button className="cta-btn-outline" onClick={() => navigate("/destinations")}>Talk to Expert</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <footer>
        <div className="footer-inner">
          ...
          <div className="footer-col">
            <h4>Destinations</h4>
            <ul>
              <li><a href="/destinations">Kathmandu Valley</a></li>
              <li><a href="/destinations">Everest Region</a></li>
              <li><a href="/destinations">Annapurna Circuit</a></li>
              <li><a href="/destinations">Chitwan Safari</a></li>
            </ul>
          </div>
          <div className="footer-col">
            <h4>Company</h4>
